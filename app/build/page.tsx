...
export default function BuildPage() {
  ...
  return <main className="build-page">
    <nav><a href="/" className="brand"><span className="brand-mark">P</span>Pep Rally</a><div className="build-progress"><span className={step >= 1 ? "active" : ""}>Idea</span><i>→</i><span className={step >= 2 ? "active" : ""}>Experience</span><i>→</i><span className={step >= 3 ? "active" : ""}>Launch pieces</span><i>→</i><span className={step >= 4 ? "active" : ""}>Test</span></div><a href="/">Back to shop</a></nav>

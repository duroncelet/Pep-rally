export const originals = [
  {
    ...
    included: ["Anonymous stay budget + lodging picker", "Guest list + RSVPs", "Budget + payment requests", "Itinerary + reservations", "Group updates + chat", "Outcome + customization Markdown"],
  ...
  },
  {
    ...
    included: ["Rows, beds, pots, or indoor", "Visual growing layout", "Live seven-day weather", "Weather-aware care tasks", "Garden journal", "Outcome + customization Markdown"],
    inputs: ["Location", "Growing setup and dimensions", "Daily sunlight", "Crops you actually want to eat"],
    outputs: ["A visual growing layout", "Crop and spacing plan", "Weather-aware care list", "A saved plan plus customization prompts"],

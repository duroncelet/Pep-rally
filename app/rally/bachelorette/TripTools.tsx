...
type Props = { city: string; start: string; end: string; count: number; onCity: (city: string) => void; onDates: (start: string, end: string) => void; onAdd: (title: string, url: string, category: string) => void; onPack: (items: string[]) => void; onPlaces: () => void; onPacking: () => void };
...
export default function TripTools({ city, start, end, count, onCity, onDates, onAdd, onPack, onPlaces, onPacking }: Props) {

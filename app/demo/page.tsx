...
export default function DemoPage() {
  return <main className="demo-page">
    <nav><Link href="/" className="brand"><span className="brand-mark">P</span>Pep Rally</Link><div className="demo-doc-links"><a href="/api/demo-brief">Demo brief</a><a className="nav-button center-link" href="/api/prd">Download PRD .md</a></div></nav>
